		...
		<Panel id={id}>
			...
			<Group>
				<FormLayout>
					...
					<Input onChange={onChangePlace} type="text" name="university" top="Место проведения" required/>
					<Select onChange={onChangeParticipationForm} top="Формат участия" placeholder=" " required>
					...
					<Select onChange={onChangeEventForm} top="Формат мероприятия" placeholder=" " required>
					...
					<Input onChange={onChangeCompanyRole} type="text" name="participants" top="Роль компании" required/>
