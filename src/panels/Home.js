...
const Home = ({ fetchedUser, id, go, setFetchApp }) => {
		...
		<Panel id={id}>
			...
			<Group>
				<FormLayout>
					...
					<Button style={{ backgroundColor: '#2787F5' }} type='submit' size='xl' disabled={!date || !nameEvent || !participants || !eventType || !description} onClick={onClickForm} onMouseUp={go} data-to="events">Добавить</Button>
