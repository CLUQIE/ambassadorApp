	...
	return (
		...
		<Panel id={id}>
            ...
            <Group header={<Header mode="secondary">Метериалы для чтения</Header>}>
                    ...
                    <Cell expandable multiline before={<Icon28CopyOutline style={{color:"#fc2c38"}}/>} target="_blank" href="https://vk.com/video-153502007_456239241"> 
                        Выступление Бориса Добродеева на форуме ПроеКТОриЯ 
                    </Cell>
                    <Cell expandable multiline before={<Icon28CopyOutline style={{color:"#fc2c38"}}/>} target="_blank" href="https://thebell.io/boris-dobrodeev-mail-ru-group-legkie-modeli-v-internete-zakonchilis">
                        Интервью Бориса Добродеева в The Bell
                    </Cell>
                    <Cell expandable multiline before={<Icon28CopyOutline style={{color:"#fc2c38"}}/>} target="_blank" href="https://www.rbc.ru/interview/technology_and_media/16/12/2019/5dee6c7d9a794758a559c774">
                        Интервью Бориса Добродеева в РБК
                    </Cell>
                    <Cell expandable multiline before={<Icon28CopyOutline style={{color:"#fc2c38"}}/>} target="_blank" href="https://corp.mail.ru/ru/company/strategy_ceo/">
                        Подробный рассказ Бориса Добродеева об экосистеме экосистем  
                    </Cell>
                    <Cell expandable multiline before={<Icon28CopyOutline style={{color:"#fc2c38"}}/>} target="_blank" href="https://corp.imgsmail.ru/media/files/esg2019.pdf">
